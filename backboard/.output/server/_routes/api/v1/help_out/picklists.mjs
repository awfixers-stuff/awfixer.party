...
//#region server/api/v1/help-out/picklists.get.ts
var picklists_get_default = defineHandler(async () => {
	if (!getConvexDeploymentUrl()) return Response.json({ error: "Convex URL not configured" }, { status: 503 });
	try {
		const data = await getConvexClient().query(api.helpOut.getFormPicklists, {});
...
//#endregion
export { picklists_get_default as default };
