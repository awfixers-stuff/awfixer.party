...
//#region server/api/v1/newsletter.get.ts
var newsletter_get_default = defineHandler(async () => {
	if (!getConvexDeploymentUrl()) return Response.json({ error: "Convex URL not configured" }, { status: 503 });
	try {
		const data = await getConvexClient().query(api.newsletter.getNewsletterSettings, {});
...
//#endregion
export { newsletter_get_default as default };
